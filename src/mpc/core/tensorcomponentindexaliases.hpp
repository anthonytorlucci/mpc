...
namespace mpc {
    namespace core {
        ...
        inline mpc::core::TensorRank4ComponentIndex ReducedTensorRank4ComponentIndex(const mpc::core::TensorRank2ComponentIndex& indexn) {
            ...
            std::pair<int,int> p_indices = mpc::utilities::GetIndexFromVoigtMatrix(index_p);
            std::pair<int,int> q_indices = mpc::utilities::GetIndexFromVoigtMatrix(index_q);
        ...
        inline int TensorRank4IndexNumberOfAliases<mpc::core::TriclinicSymmetryGroupType>(const mpc::core::TensorRankNComponentIndex<4>& indexn) {
            // returns the number of aliases for the index
            int p = mpc::utilities::GetVoigtMatrixIndex(indexn.FirstIndex(),indexn.SecondIndex());
            int q = mpc::utilities::GetVoigtMatrixIndex(indexn.ThirdIndex(),indexn.FourthIndex());
