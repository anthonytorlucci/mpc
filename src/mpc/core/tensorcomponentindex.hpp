 ...
 *    \brief structure that defines a tensor component index, i.e. the indices (i,j) or (i,j,k,l) of a tensor
 *
...
namespace mpc {
    namespace core {
         ...
         * \brief compile time rank 2 tensor index
...
// TODO: define the comparison operators outside the class, make friend, and constexpr; if constexpr, can they be used as a predicate in another template paramter value or static_assert()
         ...
         * \brief compile time rank 4 tensor index
         *     An index class with constexpr member functions that can be used as
         *     template parameter values...
         */
         ...
         * \brief the index representation of a tensor component of rank n
         *
