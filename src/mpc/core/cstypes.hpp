...
struct StiffnessType : public CSBase {
    ...
    constexpr static inline CSEnumeration CSEnum() { return CSEnumeration::STIFFNESS; }
};

struct ComplianceType : public CSBase {
    const CSEnumeration cs_enumeration = CSEnumeration::COMPLIANCE;
    constexpr static inline CSEnumeration CSEnum() { return CSEnumeration::COMPLIANCE; }
};
