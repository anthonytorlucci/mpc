...
namespace mpc {
    namespace utilities {
        ...
        constexpr inline int CGetVoigtMatrixIndex() {
            return 0;
        }

        //// 0,1
        template <>
        constexpr inline int CGetVoigtMatrixIndex<0,1>() {
            return 5;
        }

        //// 0,2
        template <>
        constexpr inline int CGetVoigtMatrixIndex<0,2>() {
            return 4;
        }

        //// 1,0
        template <>
        constexpr inline int CGetVoigtMatrixIndex<1,0>() {
            return 5;
        }

        //// 1,1
        template <>
        constexpr inline int CGetVoigtMatrixIndex<1,1>() {
            return 1;
        }

        //// 1,2
        template <>
        constexpr inline int CGetVoigtMatrixIndex<1,2>() {
            return 3;
        }

        //// 2,0
        template <>
        constexpr inline int CGetVoigtMatrixIndex<2,0>() {
            return 4;
        }

        //// 2,1
        template <>
        constexpr inline int CGetVoigtMatrixIndex<2,1>() {
            return 3;
        }

        //// 2,2
        template <>
        constexpr inline int CGetVoigtMatrixIndex<2,2>() {
            return 2;
        }
        ...
        //// 0
        template <int P=0>
        constexpr inline int CGetFirstIndexFromVoigtMatrix() {
            return 0;
        }

        template <int P=0>
        constexpr inline int CGetSecondIndexFromVoigtMatrix() {
            return 0;
        }
        ...
        //// 1
        template <>
        constexpr inline int CGetFirstIndexFromVoigtMatrix<1>() {
            return 1;
        }

        template <>
        constexpr inline int CGetSecondIndexFromVoigtMatrix<1>() {
            return 1;
        }
        ...
        //// 2
        template <>
        constexpr inline int CGetFirstIndexFromVoigtMatrix<2>() {
            return 2;
        }

        template <>
        constexpr inline int CGetSecondIndexFromVoigtMatrix<2>() {
            return 2;
        }
        ...
        //// 3
        template <>
        constexpr inline int CGetFirstIndexFromVoigtMatrix<3>() {
            return 1;
        }

        template <>
        constexpr inline int CGetSecondIndexFromVoigtMatrix<3>() {
            return 2;
        }
        ...
        //// 4
        template <>
        constexpr inline int CGetFirstIndexFromVoigtMatrix<4>() {
            return 0;
        }

        template <>
        constexpr inline int CGetSecondIndexFromVoigtMatrix<4>() {
            return 2;
        }
        ...
        //// 5
        template <>
        constexpr inline int CGetFirstIndexFromVoigtMatrix<5>() {
            return 0;
        }

        template <>
        constexpr inline int CGetSecondIndexFromVoigtMatrix<5>() {
            return 1;
        }
        ...
        int GetVoigtMatrixIndex(int ibase0, int jbase0) {
            ...
            blitz::Array<int,2> kdelta = mpc::utilities::KroneckerDelta<int,3>();
            int ibase1 = ibase0 + 1;
            int jbase1 = jbase0 + 1;
