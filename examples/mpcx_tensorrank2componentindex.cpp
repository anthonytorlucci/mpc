...
void mpcexamples::mpcTensorRank2ComponentIndex() {
    ...
    */
    ...
    std::cout << "" << std::endl;
    blitz::TinyVector<int,2> blitz_index00 =
            mpc::core::TensorRankNComponentIndex<2>::ToBlitzTinyVector(index00);
    std::cout << "TinyVector blitz_index00 : " << blitz_index00 << std::endl;

    blitz::TinyVector<int,2> blitz_index01 =
            mpc::core::TensorRank2ComponentIndex::ToBlitzTinyVector(index01);
    std::cout << "TinyVector blitz_index01 : " << blitz_index01 << std::endl;

    blitz::TinyVector<int,2> blitz_index02 =
            mpc::core::TensorRank2ComponentIndex::ToBlitzTinyVector(index02);
    std::cout << "TinyVector blitz_index02 : " << blitz_index02 << std::endl;

    blitz::TinyVector<int,2> blitz_index10 =
            mpc::core::TensorRank2ComponentIndex::ToBlitzTinyVector(index10);
    std::cout << "TinyVector blitz_index10 : " << blitz_index10 << std::endl;

    blitz::TinyVector<int,2> blitz_index11 =
            mpc::core::TensorRank2ComponentIndex::ToBlitzTinyVector(index11);
    std::cout << "TinyVector blitz_index11 : " << blitz_index11 << std::endl;

    blitz::TinyVector<int,2> blitz_index12 =
            mpc::core::TensorRank2ComponentIndex::ToBlitzTinyVector(index12);
    std::cout << "TinyVector blitz_index12 : " << blitz_index12 << std::endl;

    blitz::TinyVector<int,2> blitz_index20 =
            mpc::core::TensorRank2ComponentIndex::ToBlitzTinyVector(index20);
    std::cout << "TinyVector blitz_index20 : " << blitz_index20 << std::endl;

    blitz::TinyVector<int,2> blitz_index21 =
            mpc::core::TensorRank2ComponentIndex::ToBlitzTinyVector(index21);
    std::cout << "TinyVector blitz_index21 : " << blitz_index21 << std::endl;

    blitz::TinyVector<int,2> blitz_index22 =
            mpc::core::TensorRank2ComponentIndex::ToBlitzTinyVector(index22);
