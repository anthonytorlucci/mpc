...
void mpcexamples::mpcHookesLawCSRelationship() {
    // -------------------------------------------------------------- MPCTEST041
    /** Hooke's law and C<->S Relationships */
    std::cout << "" << std::endl;
    ...
    */
    ...
    mpc::core::StiffnessTensor<double> stiffness_tensor_triclinic;
    stiffness_tensor_triclinic.SetComponentsWithSymmetry<mpc::core::IsotropicSymmetryGroupType>(triclinic_symmetry_aliased_set_00);
