#ifndef MPCEXAMPLEAPP_SOLIDPHASEVIEW_H
#define MPCEXAMPLEAPP_SOLIDPHASEVIEW_H
...
class SolidPhaseView : public QWidget {
Q_OBJECT
public:
    explicit SolidPhaseView(QWidget *parent = nullptr);
    ~SolidPhaseView();
...
#endif //MPCEXAMPLEAPP_SOLIDPHASEVIEW_H
